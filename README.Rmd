...
2. Install the [covidData](https://github.com/reichlab/covidData) R package.
3. Install the [hubEnsembles](https://github.com/Infectious-Disease-Modeling-Hubs/hubEnsembles) R package.
4. Install the [covidHubUtils](https://github.com/reichlab/covidHubUtils) R package.
5. Install the sarix python module:
    - clone [the sarix repository](https://github.com/elray1/sarix) and from within that directory, run `pip3 install -e .`
